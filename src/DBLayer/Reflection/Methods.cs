...
/// <summary>
/// This API supports the DBLayer infrastructure and is not intended to be used  directly from your code.
...
public static class Methods
{
	...
	public static class DBLayer
	{
		...
		public static class Table
		{
			...
			public static readonly MethodInfo TableOptions = MemberHelper.MethodOfGeneric<ITable<int>>(t => t.TableOptions(global::DBLayer.TableOptions.NotSet));
		...
		{
			public static readonly MethodInfo Rollup       = MemberHelper.MethodOfGeneric<global::DBLayer.Sql.IGroupBy>(g => g.Rollup<object>(null!));
			public static readonly MethodInfo Cube         = MemberHelper.MethodOfGeneric<global::DBLayer.Sql.IGroupBy>(g => g.Cube<object>(null!));
			public static readonly MethodInfo GroupingSets = MemberHelper.MethodOfGeneric<global::DBLayer.Sql.IGroupBy>(g => g.GroupingSets<object>(null!));

			public static readonly MethodInfo Grouping     = MemberHelper.MethodOf(() => global::DBLayer.Sql.Grouping(null!));
		}

		public static class SqlExt
		{
			public static readonly MethodInfo ToNotNull     = MemberHelper.MethodOfGeneric<int?>(i => global::DBLayer.Sql.ToNotNull(i));
			public static readonly MethodInfo ToNotNullable = MemberHelper.MethodOfGeneric<int?>(i => global::DBLayer.Sql.ToNotNullable(i));
			public static readonly MethodInfo Alias         = MemberHelper.MethodOfGeneric<int?>(i => global::DBLayer.Sql.Alias(i, ""));
			// don't use MethodOfGeneric here (Sql.Property treatened in special way by it)
			public static readonly MethodInfo Property      = typeof(global::DBLayer.Sql).GetMethodEx(nameof(global::DBLayer.Sql.Property))!.GetGenericMethodDefinition();
		}
