...
/// <summary>
/// Used to build <see cref="DBLayerConnectionOptions"/>
/// which is used by <see cref="DataConnection"/>
/// to determine connection settings.
/// </summary>
public class DBLayerConnectionOptionsBuilder
{
    ...
    private void CheckAssignSetupType(ConnectionSetupType type)
    {
        if (SetupType != ConnectionSetupType.DefaultConfiguration)
            throw new DBLayerException(
                $"{nameof(DBLayerConnectionOptionsBuilder)} already setup using {SetupType}, use Reset first to overwrite");
        SetupType = type;
    }
    ...
    /// </summary>
    public DBLayerConnectionOptions<TContext> Build<TContext>()
    {
        return new DBLayerConnectionOptions<TContext>(this);
    }

    /// <summary>
    /// Build the immutable options used by the database.
    /// </summary>
    public DBLayerConnectionOptions Build()
    {
        return new DBLayerConnectionOptions(this);
    }

    /// <summary>
    /// Configure the database to use the specified provider and connection string.
    /// </summary>
    /// <param name="providerName">See <see cref="DBLayer.ProviderName"/> for Default providers.</param>
    /// <param name="connectionString">Database specific connections string.</param>
    /// <returns>The builder instance so calls can be chained.</returns>
    public DBLayerConnectionOptionsBuilder UseConnectionString(
        string providerName,
    ...
    /// <returns>The builder instance so calls can be chained.</returns>
    public DBLayerConnectionOptionsBuilder UseConfigurationString(
    ...
    /// <returns>The builder instance so calls can be chained.</returns>
    public DBLayerConnectionOptionsBuilder UseConnectionFactory(
        IDataProvider dataProvider,
    ...
    /// <returns>The builder instance so calls can be chained.</returns>
    public DBLayerConnectionOptionsBuilder UseConnection(
        IDataProvider dataProvider,
    ...
    /// <returns>The builder instance so calls can be chained.</returns>
    public DBLayerConnectionOptionsBuilder UseTransaction(IDataProvider dataProvider,
    ...
    /// <returns>The builder instance so calls can be chained.</returns>
    public DBLayerConnectionOptionsBuilder UseMappingSchema(MappingSchema mappingSchema)
    {
    ...
    /// <param name="dataProvider">Used by the connection to determine functionality when executing commands/queries.</param>
    /// <returns>The builder instance so calls can be chained.</returns>
    public DBLayerConnectionOptionsBuilder UseDataProvider(IDataProvider dataProvider)
    {
        DataProvider = dataProvider ?? throw new ArgumentNullException(nameof(dataProvider));
        return this;
    }
    ...
    /// </summary>
    /// <returns>The builder instance so calls can be chained.</returns>
    public DBLayerConnectionOptionsBuilder WithTraceLevel(TraceLevel traceLevel)
    {
    ...
    /// <returns>The builder instance so calls can be chained.</returns>
    public DBLayerConnectionOptionsBuilder WithTracing(Action<TraceInfo> onTrace)
    {
        OnTrace = onTrace;
        return this;
    }
    ...
    /// <param name="onTrace">Callback, may not be called depending on the trace level.</param>
    /// <returns>The builder instance so calls can be chained.</returns>
    public DBLayerConnectionOptionsBuilder WithTracing(TraceLevel traceLevel, Action<TraceInfo> onTrace)
    {
        TraceLevel = traceLevel;
        OnTrace = onTrace;
        return this;
    ...
    public DBLayerConnectionOptionsBuilder WithInterceptor(IInterceptor interceptor)
    {
    ...
    /// <returns>The builder instance so calls can be chained.</returns>
    public DBLayerConnectionOptionsBuilder WriteTraceWith(Action<string?, string?, TraceLevel> write)
    {
        WriteTrace = write;
        return this;
    }
    ...
    /// </summary>
    /// <returns>The builder instance so calls can be chained.</returns>
    public DBLayerConnectionOptionsBuilder Reset()
    {
        MappingSchema = null;
        DataProvider = null;
    ...
    /// </summary>
    internal DBLayerConnectionOptionsBuilder Clone()
    {
        return new DBLayerConnectionOptionsBuilder()
        {
