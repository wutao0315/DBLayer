...
public static class DBLayerConnectionOptionsBuilderExtensions
{
	...
	/// </para>
	/// </remarks>
	[Obsolete("Use UseOracle(this DBLayerConnectionOptionsBuilder builder, string connectionString, OracleVersion dialect, OracleProvider provider) overload")]
	public static DBLayerConnectionOptionsBuilder UseOracle(this DBLayerConnectionOptionsBuilder builder, string connectionString, OracleVersion dialect)
	{
	...
	/// <returns>The builder instance so calls can be chained.</returns>
	[Obsolete("Use UseOracle(this DBLayerConnectionOptionsBuilder builder, string connectionString, OracleVersion dialect, OracleProvider provider) overload")]
	public static DBLayerConnectionOptionsBuilder UseOracle(this DBLayerConnectionOptionsBuilder builder, string connectionString, OracleVersion dialect, bool useNativeProvider)
	{
