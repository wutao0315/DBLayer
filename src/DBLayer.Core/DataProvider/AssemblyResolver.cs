...
namespace DBLayer.DataProvider
{
	class AssemblyResolver
	{
		...
		void SetResolver()
		{
			...
			// use this to avoid
			// System.MethodAccessException : Attempt by security transparent method 'DBLayer.DataProvider.AssemblyResolver.SetResolver()' to access security critical method 'System.AppDomain.add_AssemblyResolve(System.ResolveEventHandler)'
