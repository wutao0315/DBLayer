...
public static partial class LinqExtensions
{
		...
		where T : notnull
	{
		...
		table.Expression = Expression.Call(
			null,
			Methods.DBLayer.Table.WithTableExpression.MakeGenericMethod(typeof(T)),
	...
	public static int Delete<T>(this IQueryable<T> source)
	{
		...
		return currentSource.Provider.Execute<int>(
			Expression.Call(
				null,
				Methods.DBLayer.Delete.DeleteQueryable.MakeGenericMethod(typeof(T)),
				currentSource.Expression));
	}
		                ...
		                Expression<Func<T,bool>> predicate)
	{
		...
		return currentSource.Provider.Execute<int>(
			Expression.Call(
				null,
				Methods.DBLayer.Delete.DeleteQueryablePredicate.MakeGenericMethod(typeof(T)),
		...
		where TTarget : notnull
	{
		...
		return currentSource.Provider.Execute<int>(
			Expression.Call(
				null,
				Methods.DBLayer.Update.UpdateTarget.MakeGenericMethod(typeof(TSource), typeof(TTarget)),
	...
	public static int Update<T>(this IQueryable<T> source,                 Expression<Func<T,T>> setter)
	{
		...
		return currentSource.Provider.Execute<int>(
			Expression.Call(
				null,
				Methods.DBLayer.Update.UpdateSetter.MakeGenericMethod(typeof(T)),
		                ...
		                Expression<Func<T,T>>    setter)
	{
		...
		return currentSource.Provider.Execute<int>(
			Expression.Call(
				null,
				Methods.DBLayer.Update.UpdatePredicateSetter.MakeGenericMethod(typeof(T)),
	...
	public static int Update<T>(this IUpdatable<T> source)
	{
		...
		return currentQuery.Provider.Execute<int>(
			Expression.Call(
				null,
				Methods.DBLayer.Update.UpdateUpdatable.MakeGenericMethod(typeof(T)),
		                ...
		                Expression<Func<TSource,TTarget>> setter)
	{
		...
		return currentSource.Provider.Execute<int>(
			Expression.Call(
				null,
				Methods.DBLayer.Update.UpdateTargetFuncSetter.MakeGenericMethod(typeof(TSource), typeof(TTarget)),
	...
	public static IUpdatable<T> AsUpdatable<T>(this IQueryable<T> source)
	{
		...
		var query = currentSource.Provider.CreateQuery<T>(
			Expression.Call(
				null,
				Methods.DBLayer.Update.AsUpdatable.MakeGenericMethod(typeof(T)),
				currentSource.Expression));
		                ...
		                Expression<Func<T,TV>> update)
	{
		...
		var query = currentSource.Provider.CreateQuery<T>(
			Expression.Call(
				null,
				Methods.DBLayer.Update.SetQueryablePrev.MakeGenericMethod(typeof(T), typeof(TV)),
		                ...
		                Expression<Func<T,TV>> update)
	{
		...
		query = query.Provider.CreateQuery<T>(
			Expression.Call(
				null,
				Methods.DBLayer.Update.SetUpdatablePrev.MakeGenericMethod(typeof(T), typeof(TV)),
		                ...
		                Expression<Func<TV>>   update)
	{
		...
		var query = source.Provider.CreateQuery<T>(
			Expression.Call(
				null,
				Methods.DBLayer.Update.SetQueryableExpression.MakeGenericMethod(typeof(T), typeof(TV)),
		                ...
		                Expression<Func<TV>>   update)
	{
		...
		query = query.Provider.CreateQuery<T>(
			Expression.Call(
				null,
				Methods.DBLayer.Update.SetUpdatableExpression.MakeGenericMethod(typeof(T), typeof(TV)),
				query.Expression, Expression.Quote(extract), Expression.Quote(update)));
		...
		[SkipIfConstant] TV                     value)
	{
		...
		var query = currentSource.Provider.CreateQuery<T>(
			Expression.Call(
				null,
				Methods.DBLayer.Update.SetQueryableValue.MakeGenericMethod(typeof(T), typeof(TV)),
		...
		[SkipIfConstant] TV                     value)
	{
		...
		query = query.Provider.CreateQuery<T>(
			Expression.Call(
				null,
				Methods.DBLayer.Update.SetUpdatableValue.MakeGenericMethod(typeof(T), typeof(TV)),
		                ...
		                Expression<Func<T,string>> setExpression)
	{
		...
		var query = currentSource.Provider.CreateQuery<T>(
			Expression.Call(
				null,
				Methods.DBLayer.Update.SetQueryableSetCustom.MakeGenericMethod(typeof(T)),
		                ...
		                Expression<Func<T,string>> setExpression)
	{
		...
		query = query.Provider.CreateQuery<T>(
			Expression.Call(
				null,
				Methods.DBLayer.Update.SetUpdatableSetCustom.MakeGenericMethod(typeof(T)),
		...
		where T : notnull
	{
		...
		var query = currentSource.Provider.CreateQuery<T>(
			Expression.Call(
				null,
				Methods.DBLayer.Insert.T.AsValueInsertable.MakeGenericMethod(typeof(T)),
				currentSource.Expression));
	...
	public static int Insert<T>(this IValueInsertable<T> source)
	{
		...
		return currentQuery.Provider.Execute<int>(
			Expression.Call(
				null,
				Methods.DBLayer.Insert.VI.Insert.MakeGenericMethod(typeof(T)),
				currentQuery.Expression));
	}
	...
	public static int Insert<TSource,TTarget>(this ISelectInsertable<TSource,TTarget> source)
	{
		...
		return currentQuery.Provider.Execute<int>(
			Expression.Call(
				null,
				Methods.DBLayer.Insert.SI.Insert.MakeGenericMethod(typeof(TSource), typeof(TTarget)),
				currentQuery.Expression));
	}
		                    ...
		                    Expression<Func<TOuter, TInner, TResult>> resultSelector)
	{
		...
		return currentOuter.Provider.CreateQuery<TResult>(
			Expression.Call(
				null,
				Methods.DBLayer.JoinTypePredicateSelector.MakeGenericMethod(typeof(TOuter), typeof(TInner), typeof(TResult)),
