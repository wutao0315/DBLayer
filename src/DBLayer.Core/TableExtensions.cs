	...
	public static class TableExtensions
	{
			...
			where T : notnull
		{
			return ((ITableMutable<T>)table).ChangeTableOptions(isTemporary
				? table.TableOptions | DBLayer.TableOptions.IsTemporary
				: table.TableOptions & ~DBLayer.TableOptions.IsTemporary);
		}
		...
		public static ITable<T> IsTemporary<T>(this ITable<T> table)
			where T : notnull
		{
			return ((ITableMutable<T>)table).ChangeTableOptions(table.TableOptions | DBLayer.TableOptions.IsTemporary);
		}
