...
namespace DBLayer.Persistence.Generator
{
    ...
    /// </summary>
    public class SnowflakeGenerator : IGenerator, IDeGenerator
    {
        // 开始时间截((new DateTime(2020, 1, 1, 0, 0, 0, DateTimeKind.Utc)-Jan1st1970).TotalMilliseconds)
        private readonly long twepoch = 1577836800000L;
        ...
        /// <param name="startDt">开始时间((new DateTime(2020, 1, 1, 0, 0, 0, DateTimeKind.Utc)-Jan1st1970).TotalMilliseconds)</param>
        public SnowflakeGenerator(long datacenterId, long workerId, DateTime? startDt = null)
        {
            ...
            var startDtUtc = startDt ?? new DateTime(2020, 1, 1, 0, 0, 0);
            this.twepoch = (long)((startDtUtc.ToUniversalTime() - Jan1st1970).TotalMilliseconds);
        }
