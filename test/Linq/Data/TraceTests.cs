...
#pragma warning restore CS0618 // Type or member is obsolete
			...
			var builder = new DBLayerConnectionOptionsBuilder().WithTracing(info => builderTraceCalled = true);
		...
		public void TraceSwitchShouldUseFromBuilder()
		{
			...
			var builder = new DBLayerConnectionOptionsBuilder().WithTraceLevel(builderTraceLevel);
		...
		public void WriteTraceInstanceShouldUseFromBuilder()
		{
			...
			var builder = new DBLayerConnectionOptionsBuilder()
