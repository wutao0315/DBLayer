...
namespace Tests.DataProvider
{
	...
	public class SqlServerTests : DataProviderTestBase
	{
		...
		{
			[Identity]
			[Column(DataType=DataType.Int32),          DBLayer.Mapping.NotNull] public int             ID                       { get; set; }
...
");
		...
		public DBLayer.ITable<Issue1294Table> GetPermissions(int p1, int p2)
		{
...
");
				...
				DBLayer.ITable<Issue1294Table> CallFunc(int p1, int p2)
				{
		...
		[Sql.TableFunction("PersonTableFunction", argIndices: new []{2, 3})]
		static DBLayer.ITable<Person> PersonTableFunctionTable(IDataContext dc, object? fake, int? id, string? firstName)
		{
			return dc.GetTable<Person>(null, (MethodInfo)MethodBase.GetCurrentMethod()!, dc, fake, id, firstName);
		}
		...
		[Sql.TableExpression("PersonTableFunction({4}, {5}) {1}")]
		static DBLayer.ITable<Person> PersonTableExpressionTable(IDataContext dc, object? fake, int? id, string? firstName)
		{
			return dc.GetTable<Person>(null, (MethodInfo)MethodBase.GetCurrentMethod()!, dc, fake, id, firstName);
		}
