...
#region XmlTable
		...
		internal class TestOracleDataProvider : OracleDataProvider
		{
		...
		class MyTestDataConnectionInterceptor : CommandInterceptor
		{
...
CREATE TABLE ""TABLE_A""(
	...
	CONSTRAINT ""PK_TABLE_A"" PRIMARY KEY(""COLUMN_A"", ""COLUMN_B"", ""COLUMN_C"")
		...
		[Table("LinqDataTypes", IsColumnAttributeRequired = false)]
		class LinqDataTypesBlobsDevart
		{
			public int ID { get; set; }
			// Implicit OracleBlob support, no attribute
		...
		static class OracleModuleFunctions
		{
			...
			public static DBLayer.ITable<Record> TestTableFunction(IDataContext db, int param1)
			{
			...
			public static DBLayer.ITable<Record> TestTableFunctionP1(IDataContext db, int param1)
			{
				return db.GetTable<Record>(null, (MethodInfo)MethodBase.GetCurrentMethod()!, db, param1);
			}

			[Sql.TableFunction("TEST_TABLE_FUNCTION", argIndices: new[] { 1 }, Package = "TEST_PACKAGE2")]
			public static DBLayer.ITable<Record> TestTableFunctionP2(IDataContext db, int param1)
			{
				return db.GetTable<Record>(null, (MethodInfo)MethodBase.GetCurrentMethod()!, db, param1);
			}
