...
namespace Tests.UserTests
{
	...
	{
		internal class DBLayerDynamicLinqCustomTypeProvider : DefaultDynamicLinqCustomTypeProvider
		{
		...
		{
			ParsingConfig.Default.CustomTypeProvider = new DBLayerDynamicLinqCustomTypeProvider();
