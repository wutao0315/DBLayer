...
{
	/// <summary>
	/// Test checks for race conditions in <see cref="MappingSchema"/> around <see cref="DBLayer.Metadata.IMetadataReader"/>
	...
	public class Issue548Tests
	{
		...
		/// are creating two instances of <see cref="FluentMappingBuilder"/> and have a chance to race in <see cref="MappingSchema.AddMetadataReader(DBLayer.Metadata.IMetadataReader)"/>
		/// one <see cref="DBLayer.Metadata.IMetadataReader"/> could be lost
		/// </summary>
		/// <param name="ms"></param>
