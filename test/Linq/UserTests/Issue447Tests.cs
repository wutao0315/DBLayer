namespace Tests.UserTests
{
	...
	{
		[Test]
		public void TestDBLayerComplexQuery2([DataSources] string context)
		{
		...
		[Test]
		public void TestDBLayerComplexQueryCache([DataSources] string context)
		{
			using (var db = GetDataContext(context))
			{
				var result = db.Child.Where(c => c.ChildID > 1 || c.ChildID > 0);
		...
		[Test]
		public void TestDBLayerComplexQueryWithParameters([DataSources] string context)
		{
			var value = true;
