...
public class TestsInitialization
{
	...
	public void TestAssemblySetup()
	{
		...
		//DBLayer.Common.Configuration.OptimizeForSequentialAccess = true;
		...
		//DBLayer.Common.Compilation.SetExpressionCompiler(_ => FastExpressionCompiler.ExpressionCompiler.CompileFast(_, true));
	}
