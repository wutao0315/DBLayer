...
namespace Default.PostgreSQL
{
	...
	public partial class AllType
	{
		...
		[Column("cidrDataType"),        Nullable            ] public ValueTuple<IPAddress, int>? CidrDataType        { get; set; } // cidr
	...
	public partial class CollatedTable
	{
		...
		[Column, NotNull] public string CaseSensitive   { get; set; } = null!; // character varying(20)
		[Column, NotNull] public string CaseInsensitive { get; set; } = null!; // character varying(20)
	}
	...
	public partial class Doctor
	{
		...
		[Column,     NotNull] public string Taxonomy { get; set; } = null!; // character varying(50)
	...
	{
		[Column("the_name"), NotNull] public string TheName { get; set; } = null!; // character varying(255)
	}
	...
	{
		[PrimaryKey, NotNull] public int    PersonID  { get; set; } // integer
		[Column,     NotNull] public string Diagnosis { get; set; } = null!; // character varying(256)
	...
	public partial class Person
	{
		...
		[Column,     NotNull    ] public string  FirstName  { get; set; } = null!; // character varying(50)
		[Column,     NotNull    ] public string  LastName   { get; set; } = null!; // character varying(50)
