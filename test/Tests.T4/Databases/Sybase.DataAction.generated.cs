...
{
	public partial class TestDataCoreDB : DBLayer.Data.DataConnection
	{
		...
		public TestDataCoreDB(DBLayerConnectionOptions options)
			: base(options)
		{
			InitDataContext();
			InitMappingSchema();
		...
		public TestDataCoreDB(DBLayerConnectionOptions<TestDataCoreDB> options)
			: base(options)
		{
			InitDataContext();
			InitMappingSchema();
	...
	public static partial class TestDataCoreDBStoredProcedures
	{
		...
		public static int AddIssue792Record(this TestDataCoreDB dataConnection, out int? RETURN_VALUE)
		{
			var parameters = new []
			{
				new DataParameter("RETURN_VALUE", null, DBLayer.DataType.Int32)
				{
