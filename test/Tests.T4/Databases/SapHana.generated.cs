...
{
	public partial class SYSTEMDBDB : DBLayer.Data.DataConnection
	{
		...
		public SYSTEMDBDB(DBLayerConnectionOptions options)
			: base(options)
		{
			InitDataContext();
			InitMappingSchema();
		...
		public SYSTEMDBDB(DBLayerConnectionOptions<SYSTEMDBDB> options)
			: base(options)
		{
			InitDataContext();
			InitMappingSchema();
	...
	public static partial class SYSTEMDBDBStoredProcedures
	{
		...
		public static int DROPCONSTRAINTFROMTABLE(this SYSTEMDBDB dataConnection, string? TABLENAME, string? CONSTRAINTNAME, string? SCHEMANAME)
		{
			var parameters = new []
			{
				new DataParameter("TABLENAME",      TABLENAME,      DBLayer.DataType.VarChar)
				{
					Size = 50
				},
				new DataParameter("CONSTRAINTNAME", CONSTRAINTNAME, DBLayer.DataType.VarChar)
				{
					Size = 100
				},
				new DataParameter("SCHEMANAME",     SCHEMANAME,     DBLayer.DataType.VarChar)
				{
					Size = 50
				}
			};
		...
		public static int DROPEXISTINGFUNCTION(this SYSTEMDBDB dataConnection, string? FUNCTIONNAME, string? SCHEMANAME)
		{
			var parameters = new []
			{
				new DataParameter("FUNCTIONNAME", FUNCTIONNAME, DBLayer.DataType.VarChar)
				{
					Size = 50
				},
				new DataParameter("SCHEMANAME",   SCHEMANAME,   DBLayer.DataType.VarChar)
		...
		public static int DROPEXISTINGPROCEDURE(this SYSTEMDBDB dataConnection, string? PROCEDURENAME, string? SCHEMANAME)
		{
			var parameters = new []
			{
				new DataParameter("PROCEDURENAME", PROCEDURENAME, DBLayer.DataType.VarChar)
				{
					Size = 50
				},
				new DataParameter("SCHEMANAME",    SCHEMANAME,    DBLayer.DataType.VarChar)
		...
		public static int DROPEXISTINGVIEW(this SYSTEMDBDB dataConnection, string? VIEWNAME, string? SCHEMANAME)
		{
			var parameters = new []
			{
				new DataParameter("VIEWNAME",   VIEWNAME,   DBLayer.DataType.VarChar)
				{
					Size = 50
				},
				new DataParameter("SCHEMANAME", SCHEMANAME, DBLayer.DataType.VarChar)
		...
		public static int OutRefEnumTest(this SYSTEMDBDB dataConnection, string? STR, out string? OUTPUTSTR, ref string? INPUTOUTPUTSTR)
		{
			var parameters = new []
			{
				...
				new DataParameter("OUTPUTSTR", null,      DBLayer.DataType.VarChar)
				{
		...
		public static int OutRefTest(this SYSTEMDBDB dataConnection, int? ID, out int? OUTPUTID, ref int? INPUTOUTPUTID, string? STR, out string? OUTPUTSTR, ref string? INPUTOUTPUTSTR)
		{
			var parameters = new []
			{
				...
				new DataParameter("OUTPUTID", null,       DBLayer.DataType.Int32)
				{
					Direction = ParameterDirection.Output,
					Size      = 10
				},
		...
		public static int PersonInsertOutputParameter(this SYSTEMDBDB dataConnection, string? FIRSTNAME, string? LASTNAME, string? MIDDLENAME, char? GENDER, out int? PERSONID)
		{
			var parameters = new []
			{
				...
				new DataParameter("PERSONID", null, DBLayer.DataType.Int32)
				{
					Direction = ParameterDirection.Output,
					Size      = 10
				}
