...
{
	public partial class TestdataidsDB : DBLayer.Data.DataConnection
	{
		...
		public TestdataidsDB(DBLayerConnectionOptions options)
			: base(options)
		{
			InitDataContext();
			InitMappingSchema();
		...
		public TestdataidsDB(DBLayerConnectionOptions<TestdataidsDB> options)
			: base(options)
		{
			InitDataContext();
			InitMappingSchema();
