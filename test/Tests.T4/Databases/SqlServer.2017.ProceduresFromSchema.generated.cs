...
{
	public partial class TestDataNorthwindDB : DBLayer.Data.DataConnection
	{
	...
	{
		[Column(DbType="int",          DataType=DBLayer.DataType.Int32),               NotNull    ] public int      ProductID       { get; set; } // int
		[Column(DbType="nvarchar(40)", DataType=DBLayer.DataType.NVarChar, Length=40), NotNull    ] public string   ProductName     { get; set; } = null!; // nvarchar(40)
		[Column(DbType="int",          DataType=DBLayer.DataType.Int32),                  Nullable] public int?     SupplierID      { get; set; } // int
		[Column(DbType="int",          DataType=DBLayer.DataType.Int32),                  Nullable] public int?     CategoryID      { get; set; } // int
		[Column(DbType="nvarchar(20)", DataType=DBLayer.DataType.NVarChar, Length=20),    Nullable] public string?  QuantityPerUnit { get; set; } // nvarchar(20)
		[Column(DbType="money",        DataType=DBLayer.DataType.Money),                  Nullable] public decimal? UnitPrice       { get; set; } // money
		[Column(DbType="smallint",     DataType=DBLayer.DataType.Int16),                  Nullable] public short?   UnitsInStock    { get; set; } // smallint
		[Column(DbType="smallint",     DataType=DBLayer.DataType.Int16),                  Nullable] public short?   UnitsOnOrder    { get; set; } // smallint
		[Column(DbType="smallint",     DataType=DBLayer.DataType.Int16),                  Nullable] public short?   ReorderLevel    { get; set; } // smallint
		[Column(DbType="bit",          DataType=DBLayer.DataType.Boolean),             NotNull    ] public bool     Discontinued    { get; set; } // bit
		[Column(DbType="nvarchar(15)", DataType=DBLayer.DataType.NVarChar, Length=15), NotNull    ] public string   CategoryName    { get; set; } = null!; // nvarchar(15)
	}

	[Table("Categories")]
	public partial class Category
	{
		[Column(DbType="int",          DataType=DBLayer.DataType.Int32),               SequenceName("https://github.com/linq2db/linq2db/issues/1866"), PrimaryKey, Identity] public int     CategoryID   { get; set; } // int
		[Column(DbType="nvarchar(15)", DataType=DBLayer.DataType.NVarChar, Length=15), NotNull                                                                             ] public string  CategoryName { get; set; } = null!; // nvarchar(15)
		[Column(DbType="ntext",        DataType=DBLayer.DataType.NText),                  Nullable                                                                         ] public string? Description  { get; set; } // ntext
		[Column(DbType="image",        DataType=DBLayer.DataType.Image),                  Nullable                                                                         ] public byte[]? Picture      { get; set; } // image
	}
	...
	{
		[Column(DbType="nvarchar(15)", DataType=DBLayer.DataType.NVarChar, Length=15), NotNull    ] public string   CategoryName  { get; set; } = null!; // nvarchar(15)
		[Column(DbType="money",        DataType=DBLayer.DataType.Money),                  Nullable] public decimal? CategorySales { get; set; } // money
	}

	[Table("Current Product List", IsView=true)]
	public partial class CurrentProductList
	{
		[Column(DbType="int",          DataType=DBLayer.DataType.Int32),               Identity] public int    ProductID   { get; set; } // int
		[Column(DbType="nvarchar(40)", DataType=DBLayer.DataType.NVarChar, Length=40), NotNull ] public string ProductName { get; set; } = null!; // nvarchar(40)
	}
	...
	{
		[Column(DbType="nchar(5)",     DataType=DBLayer.DataType.NChar,    Length=5),  PrimaryKey,  NotNull] public string  CustomerID   { get; set; } = null!; // nchar(5)
		[Column(DbType="nvarchar(40)", DataType=DBLayer.DataType.NVarChar, Length=40),              NotNull] public string  CompanyName  { get; set; } = null!; // nvarchar(40)
		[Column(DbType="nvarchar(30)", DataType=DBLayer.DataType.NVarChar, Length=30),    Nullable         ] public string? ContactName  { get; set; } // nvarchar(30)
		[Column(DbType="nvarchar(30)", DataType=DBLayer.DataType.NVarChar, Length=30),    Nullable         ] public string? ContactTitle { get; set; } // nvarchar(30)
		[Column(DbType="nvarchar(60)", DataType=DBLayer.DataType.NVarChar, Length=60),    Nullable         ] public string? Address      { get; set; } // nvarchar(60)
		[Column(DbType="nvarchar(15)", DataType=DBLayer.DataType.NVarChar, Length=15),    Nullable         ] public string? City         { get; set; } // nvarchar(15)
		[Column(DbType="nvarchar(15)", DataType=DBLayer.DataType.NVarChar, Length=15),    Nullable         ] public string? Region       { get; set; } // nvarchar(15)
		[Column(DbType="nvarchar(10)", DataType=DBLayer.DataType.NVarChar, Length=10),    Nullable         ] public string? PostalCode   { get; set; } // nvarchar(10)
		[Column(DbType="nvarchar(15)", DataType=DBLayer.DataType.NVarChar, Length=15),    Nullable         ] public string? Country      { get; set; } // nvarchar(15)
		[Column(DbType="nvarchar(24)", DataType=DBLayer.DataType.NVarChar, Length=24),    Nullable         ] public string? Phone        { get; set; } // nvarchar(24)
		[Column(DbType="nvarchar(24)", DataType=DBLayer.DataType.NVarChar, Length=24),    Nullable         ] public string? Fax          { get; set; } // nvarchar(24)
	...
	public partial class CustomerAndSuppliersByCity
	{
		...
		[Column(DbType="nvarchar(40)", DataType=DBLayer.DataType.NVarChar, Length=40), NotNull    ] public string  CompanyName  { get; set; } = null!; // nvarchar(40)
		[Column(DbType="nvarchar(30)", DataType=DBLayer.DataType.NVarChar, Length=30),    Nullable] public string? ContactName  { get; set; } // nvarchar(30)
		[Column(DbType="varchar(9)",   DataType=DBLayer.DataType.VarChar,  Length=9),  NotNull    ] public string  Relationship { get; set; } = null!; // varchar(9)
	}

	[Table("CustomerCustomerDemo")]
	public partial class CustomerCustomerDemo
	{
		[Column(DbType="nchar(5)",  DataType=DBLayer.DataType.NChar, Length=5),  PrimaryKey(1), NotNull] public string CustomerID     { get; set; } = null!; // nchar(5)
		[Column(DbType="nchar(10)", DataType=DBLayer.DataType.NChar, Length=10), PrimaryKey(2), NotNull] public string CustomerTypeID { get; set; } = null!; // nchar(10)
	...
	{
		[Column(DbType="nchar(10)", DataType=DBLayer.DataType.NChar, Length=10), PrimaryKey,  NotNull] public string  CustomerTypeID { get; set; } = null!; // nchar(10)
		[Column(DbType="ntext",     DataType=DBLayer.DataType.NText),               Nullable         ] public string? CustomerDesc   { get; set; } // ntext
	...
	{
		[Column(DbType="int",           DataType=DBLayer.DataType.Int32),                PrimaryKey,  Identity] public int       EmployeeID      { get; set; } // int
		[Column(DbType="nvarchar(20)",  DataType=DBLayer.DataType.NVarChar, Length=20),  NotNull              ] public string    LastName        { get; set; } = null!; // nvarchar(20)
		[Column(DbType="nvarchar(10)",  DataType=DBLayer.DataType.NVarChar, Length=10),  NotNull              ] public string    FirstName       { get; set; } = null!; // nvarchar(10)
		[Column(DbType="nvarchar(30)",  DataType=DBLayer.DataType.NVarChar, Length=30),     Nullable          ] public string?   Title           { get; set; } // nvarchar(30)
		[Column(DbType="nvarchar(25)",  DataType=DBLayer.DataType.NVarChar, Length=25),     Nullable          ] public string?   TitleOfCourtesy { get; set; } // nvarchar(25)
		[Column(DbType="datetime",      DataType=DBLayer.DataType.DateTime),                Nullable          ] public DateTime? BirthDate       { get; set; } // datetime
		[Column(DbType="datetime",      DataType=DBLayer.DataType.DateTime),                Nullable          ] public DateTime? HireDate        { get; set; } // datetime
		[Column(DbType="nvarchar(60)",  DataType=DBLayer.DataType.NVarChar, Length=60),     Nullable          ] public string?   Address         { get; set; } // nvarchar(60)
		[Column(DbType="nvarchar(15)",  DataType=DBLayer.DataType.NVarChar, Length=15),     Nullable          ] public string?   City            { get; set; } // nvarchar(15)
		[Column(DbType="nvarchar(15)",  DataType=DBLayer.DataType.NVarChar, Length=15),     Nullable          ] public string?   Region          { get; set; } // nvarchar(15)
		[Column(DbType="nvarchar(10)",  DataType=DBLayer.DataType.NVarChar, Length=10),     Nullable          ] public string?   PostalCode      { get; set; } // nvarchar(10)
		[Column(DbType="nvarchar(15)",  DataType=DBLayer.DataType.NVarChar, Length=15),     Nullable          ] public string?   Country         { get; set; } // nvarchar(15)
		[Column(DbType="nvarchar(24)",  DataType=DBLayer.DataType.NVarChar, Length=24),     Nullable          ] public string?   HomePhone       { get; set; } // nvarchar(24)
		[Column(DbType="nvarchar(4)",   DataType=DBLayer.DataType.NVarChar, Length=4),      Nullable          ] public string?   Extension       { get; set; } // nvarchar(4)
		[Column(DbType="image",         DataType=DBLayer.DataType.Image),                   Nullable          ] public byte[]?   Photo           { get; set; } // image
		[Column(DbType="ntext",         DataType=DBLayer.DataType.NText),                   Nullable          ] public string?   Notes           { get; set; } // ntext
		[Column(DbType="int",           DataType=DBLayer.DataType.Int32),                   Nullable          ] public int?      ReportsTo       { get; set; } // int
		[Column(DbType="nvarchar(255)", DataType=DBLayer.DataType.NVarChar, Length=255),    Nullable          ] public string?   PhotoPath       { get; set; } // nvarchar(255)
	...
	{
		[Column(DbType="int",          DataType=DBLayer.DataType.Int32),               PrimaryKey(1), NotNull] public int    EmployeeID  { get; set; } // int
		[Column(DbType="nvarchar(20)", DataType=DBLayer.DataType.NVarChar, Length=20), PrimaryKey(2), NotNull] public string TerritoryID { get; set; } = null!; // nvarchar(20)
	...
	{
		[Column(DbType="nvarchar(40)", DataType=DBLayer.DataType.NVarChar, Length=40),    Nullable] public string?   ShipName       { get; set; } // nvarchar(40)
		[Column(DbType="nvarchar(60)", DataType=DBLayer.DataType.NVarChar, Length=60),    Nullable] public string?   ShipAddress    { get; set; } // nvarchar(60)
		[Column(DbType="nvarchar(15)", DataType=DBLayer.DataType.NVarChar, Length=15),    Nullable] public string?   ShipCity       { get; set; } // nvarchar(15)
		[Column(DbType="nvarchar(15)", DataType=DBLayer.DataType.NVarChar, Length=15),    Nullable] public string?   ShipRegion     { get; set; } // nvarchar(15)
		[Column(DbType="nvarchar(10)", DataType=DBLayer.DataType.NVarChar, Length=10),    Nullable] public string?   ShipPostalCode { get; set; } // nvarchar(10)
		[Column(DbType="nvarchar(15)", DataType=DBLayer.DataType.NVarChar, Length=15),    Nullable] public string?   ShipCountry    { get; set; } // nvarchar(15)
		[Column(DbType="nchar(5)",     DataType=DBLayer.DataType.NChar,    Length=5),     Nullable] public string?   CustomerID     { get; set; } // nchar(5)
		[Column(DbType="nvarchar(40)", DataType=DBLayer.DataType.NVarChar, Length=40), NotNull    ] public string    CustomerName   { get; set; } = null!; // nvarchar(40)
		[Column(DbType="nvarchar(60)", DataType=DBLayer.DataType.NVarChar, Length=60),    Nullable] public string?   Address        { get; set; } // nvarchar(60)
		[Column(DbType="nvarchar(15)", DataType=DBLayer.DataType.NVarChar, Length=15),    Nullable] public string?   City           { get; set; } // nvarchar(15)
		[Column(DbType="nvarchar(15)", DataType=DBLayer.DataType.NVarChar, Length=15),    Nullable] public string?   Region         { get; set; } // nvarchar(15)
		[Column(DbType="nvarchar(10)", DataType=DBLayer.DataType.NVarChar, Length=10),    Nullable] public string?   PostalCode     { get; set; } // nvarchar(10)
		[Column(DbType="nvarchar(15)", DataType=DBLayer.DataType.NVarChar, Length=15),    Nullable] public string?   Country        { get; set; } // nvarchar(15)
		[Column(DbType="nvarchar(31)", DataType=DBLayer.DataType.NVarChar, Length=31), NotNull    ] public string    Salesperson    { get; set; } = null!; // nvarchar(31)
		[Column(DbType="int",          DataType=DBLayer.DataType.Int32),               NotNull    ] public int       OrderID        { get; set; } // int
		[Column(DbType="datetime",     DataType=DBLayer.DataType.DateTime),               Nullable] public DateTime? OrderDate      { get; set; } // datetime
		[Column(DbType="datetime",     DataType=DBLayer.DataType.DateTime),               Nullable] public DateTime? RequiredDate   { get; set; } // datetime
		[Column(DbType="datetime",     DataType=DBLayer.DataType.DateTime),               Nullable] public DateTime? ShippedDate    { get; set; } // datetime
		[Column(DbType="nvarchar(40)", DataType=DBLayer.DataType.NVarChar, Length=40), NotNull    ] public string    ShipperName    { get; set; } = null!; // nvarchar(40)
		[Column(DbType="int",          DataType=DBLayer.DataType.Int32),               NotNull    ] public int       ProductID      { get; set; } // int
		[Column(DbType="nvarchar(40)", DataType=DBLayer.DataType.NVarChar, Length=40), NotNull    ] public string    ProductName    { get; set; } = null!; // nvarchar(40)
		[Column(DbType="money",        DataType=DBLayer.DataType.Money),               NotNull    ] public decimal   UnitPrice      { get; set; } // money
		[Column(DbType="smallint",     DataType=DBLayer.DataType.Int16),               NotNull    ] public short     Quantity       { get; set; } // smallint
		[Column(DbType="real",         DataType=DBLayer.DataType.Single),              NotNull    ] public float     Discount       { get; set; } // real
		[Column(DbType="money",        DataType=DBLayer.DataType.Money),                  Nullable] public decimal?  ExtendedPrice  { get; set; } // money
		[Column(DbType="money",        DataType=DBLayer.DataType.Money),                  Nullable] public decimal?  Freight        { get; set; } // money
	}

	[Table("Orders")]
	public partial class Order
	{
		[Column(DbType="int",          DataType=DBLayer.DataType.Int32),               PrimaryKey, Identity] public int       OrderID        { get; set; } // int
		[Column(DbType="nchar(5)",     DataType=DBLayer.DataType.NChar,    Length=5),  Nullable            ] public string?   CustomerID     { get; set; } // nchar(5)
		[Column(DbType="int",          DataType=DBLayer.DataType.Int32),               Nullable            ] public int?      EmployeeID     { get; set; } // int
		[Column(DbType="datetime",     DataType=DBLayer.DataType.DateTime),            Nullable            ] public DateTime? OrderDate      { get; set; } // datetime
		[Column(DbType="datetime",     DataType=DBLayer.DataType.DateTime),            Nullable            ] public DateTime? RequiredDate   { get; set; } // datetime
		[Column(DbType="datetime",     DataType=DBLayer.DataType.DateTime),            Nullable            ] public DateTime? ShippedDate    { get; set; } // datetime
		[Column(DbType="int",          DataType=DBLayer.DataType.Int32),               Nullable            ] public int?      ShipVia        { get; set; } // int
		[Column(DbType="money",        DataType=DBLayer.DataType.Money),               Nullable            ] public decimal?  Freight        { get; set; } // money
		[Column(DbType="nvarchar(40)", DataType=DBLayer.DataType.NVarChar, Length=40), Nullable            ] public string?   ShipName       { get; set; } // nvarchar(40)
		[Column(DbType="nvarchar(60)", DataType=DBLayer.DataType.NVarChar, Length=60), Nullable            ] public string?   ShipAddress    { get; set; } // nvarchar(60)
		[Column(DbType="nvarchar(15)", DataType=DBLayer.DataType.NVarChar, Length=15), Nullable            ] public string?   ShipCity       { get; set; } // nvarchar(15)
	...
	{
		[Column("OrderID", DbType="int",      DataType=DBLayer.DataType.Int32),  PrimaryKey(1), NotNull] public int     ID        { get; set; } // int
		[Column(           DbType="int",      DataType=DBLayer.DataType.Int32),  PrimaryKey(2), NotNull] public int     ProductID { get; set; } // int
		[Column(           DbType="money",    DataType=DBLayer.DataType.Money),                 NotNull] public decimal UnitPrice { get; set; } // money
		[Column(           DbType="smallint", DataType=DBLayer.DataType.Int16),                 NotNull] public short   Quantity  { get; set; } // smallint
		[Column(           DbType="real",     DataType=DBLayer.DataType.Single),                NotNull] public float   Discount  { get; set; } // real
	...
	{
		[Column(DbType="int",   DataType=DBLayer.DataType.Int32), NotNull    ] public int      OrderID  { get; set; } // int
		[Column(DbType="money", DataType=DBLayer.DataType.Money),    Nullable] public decimal? Subtotal { get; set; } // money
	}
	...
	public partial class ProductSalesFor1997
	{
		[Column(DbType="nvarchar(15)", DataType=DBLayer.DataType.NVarChar, Length=15), NotNull    ] public string   CategoryName { get; set; } = null!; // nvarchar(15)
		[Column(DbType="nvarchar(40)", DataType=DBLayer.DataType.NVarChar, Length=40), NotNull    ] public string   ProductName  { get; set; } = null!; // nvarchar(40)
		[Column(DbType="money",        DataType=DBLayer.DataType.Money),                  Nullable] public decimal? ProductSales { get; set; } // money
	}
	...
	{
		[Column(DbType="nchar(5)",     DataType=DBLayer.DataType.NChar,    Length=5),  Nullable] public string? CustomerID  { get; set; } // nchar(5)
		[Column(DbType="nvarchar(40)", DataType=DBLayer.DataType.NVarChar, Length=40), Nullable] public string? CompanyName { get; set; } // nvarchar(40)
		[Column(DbType="nvarchar(15)", DataType=DBLayer.DataType.NVarChar, Length=15), Nullable] public string? City        { get; set; } // nvarchar(15)
		[Column(DbType="nvarchar(15)", DataType=DBLayer.DataType.NVarChar, Length=15), Nullable] public string? Country     { get; set; } // nvarchar(15)
	}
	...
	{
		[Column(DbType="int",       DataType=DBLayer.DataType.Int32),            PrimaryKey, NotNull] public int    RegionID          { get; set; } // int
		[Column(DbType="nchar(50)", DataType=DBLayer.DataType.NChar, Length=50),             NotNull] public string RegionDescription { get; set; } = null!; // nchar(50)
	...
	{
		[Column(DbType="int",          DataType=DBLayer.DataType.Int32),               NotNull    ] public int      CategoryID   { get; set; } // int
		[Column(DbType="nvarchar(15)", DataType=DBLayer.DataType.NVarChar, Length=15), NotNull    ] public string   CategoryName { get; set; } = null!; // nvarchar(15)
		[Column(DbType="nvarchar(40)", DataType=DBLayer.DataType.NVarChar, Length=40), NotNull    ] public string   ProductName  { get; set; } = null!; // nvarchar(40)
		[Column(DbType="money",        DataType=DBLayer.DataType.Money),                  Nullable] public decimal? ProductSales { get; set; } // money
	}
	...
	{
		[Column(DbType="money",        DataType=DBLayer.DataType.Money),                  Nullable] public decimal?  SaleAmount  { get; set; } // money
		[Column(DbType="int",          DataType=DBLayer.DataType.Int32),               NotNull    ] public int       OrderID     { get; set; } // int
		[Column(DbType="nvarchar(40)", DataType=DBLayer.DataType.NVarChar, Length=40), NotNull    ] public string    CompanyName { get; set; } = null!; // nvarchar(40)
		[Column(DbType="datetime",     DataType=DBLayer.DataType.DateTime),               Nullable] public DateTime? ShippedDate { get; set; } // datetime
	}
	...
	{
		[Column(DbType="int",          DataType=DBLayer.DataType.Int32),               PrimaryKey,  Identity] public int     ShipperID   { get; set; } // int
		[Column(DbType="nvarchar(40)", DataType=DBLayer.DataType.NVarChar, Length=40), NotNull              ] public string  CompanyName { get; set; } = null!; // nvarchar(40)
		[Column(DbType="nvarchar(24)", DataType=DBLayer.DataType.NVarChar, Length=24),    Nullable          ] public string? Phone       { get; set; } // nvarchar(24)
	...
	{
		[Column(DbType="int",          DataType=DBLayer.DataType.Int32),               PrimaryKey,  Identity] public int     SupplierID   { get; set; } // int
		[Column(DbType="nvarchar(40)", DataType=DBLayer.DataType.NVarChar, Length=40), NotNull              ] public string  CompanyName  { get; set; } = null!; // nvarchar(40)
		[Column(DbType="nvarchar(30)", DataType=DBLayer.DataType.NVarChar, Length=30),    Nullable          ] public string? ContactName  { get; set; } // nvarchar(30)
		[Column(DbType="nvarchar(30)", DataType=DBLayer.DataType.NVarChar, Length=30),    Nullable          ] public string? ContactTitle { get; set; } // nvarchar(30)
		[Column(DbType="nvarchar(60)", DataType=DBLayer.DataType.NVarChar, Length=60),    Nullable          ] public string? Address      { get; set; } // nvarchar(60)
		...
		[Column(DbType="nvarchar(24)", DataType=DBLayer.DataType.NVarChar, Length=24),    Nullable          ] public string? Phone        { get; set; } // nvarchar(24)
		[Column(DbType="nvarchar(24)", DataType=DBLayer.DataType.NVarChar, Length=24),    Nullable          ] public string? Fax          { get; set; } // nvarchar(24)
		[Column(DbType="ntext",        DataType=DBLayer.DataType.NText),                  Nullable          ] public string? HomePage     { get; set; } // ntext
	}

	[Table("Territories")]
	public partial class Territory
	{
		[Column(DbType="nvarchar(20)", DataType=DBLayer.DataType.NVarChar, Length=20), PrimaryKey, NotNull] public string TerritoryID          { get; set; } = null!; // nvarchar(20)
		[Column(DbType="nchar(50)",    DataType=DBLayer.DataType.NChar,    Length=50),             NotNull] public string TerritoryDescription { get; set; } = null!; // nchar(50)
		[Column(DbType="int",          DataType=DBLayer.DataType.Int32),                           NotNull] public int    RegionID             { get; set; } // int
	...
	public partial class TestData2017DB : DBLayer.Data.DataConnection
	{
	...
	{
		[Column(                            DbType="int",               DataType=DBLayer.DataType.Int32),                                                PrimaryKey, Identity] public int             ID                       { get; set; } // int
		[Column("bigintDataType",           DbType="bigint",            DataType=DBLayer.DataType.Int64),                                                Nullable            ] public long?           BigintDataType           { get; set; } // bigint
		[Column("numericDataType",          DbType="numeric(18, 1)",    DataType=DBLayer.DataType.Decimal,        Precision=18, Scale=1),                Nullable            ] public decimal?        NumericDataType          { get; set; } // numeric(18, 1)
		[Column("bitDataType",              DbType="bit",               DataType=DBLayer.DataType.Boolean),                                              Nullable            ] public bool?           BitDataType              { get; set; } // bit
		[Column("smallintDataType",         DbType="smallint",          DataType=DBLayer.DataType.Int16),                                                Nullable            ] public short?          SmallintDataType         { get; set; } // smallint
		[Column("decimalDataType",          DbType="decimal(18, 1)",    DataType=DBLayer.DataType.Decimal,        Precision=18, Scale=1),                Nullable            ] public decimal?        DecimalDataType          { get; set; } // decimal(18, 1)
		[Column("smallmoneyDataType",       DbType="smallmoney",        DataType=DBLayer.DataType.SmallMoney),                                           Nullable            ] public decimal?        SmallmoneyDataType       { get; set; } // smallmoney
		[Column("intDataType",              DbType="int",               DataType=DBLayer.DataType.Int32),                                                Nullable            ] public int?            IntDataType              { get; set; } // int
		[Column("tinyintDataType",          DbType="tinyint",           DataType=DBLayer.DataType.Byte),                                                 Nullable            ] public byte?           TinyintDataType          { get; set; } // tinyint
		[Column("moneyDataType",            DbType="money",             DataType=DBLayer.DataType.Money),                                                Nullable            ] public decimal?        MoneyDataType            { get; set; } // money
		[Column("floatDataType",            DbType="float",             DataType=DBLayer.DataType.Double),                                               Nullable            ] public double?         FloatDataType            { get; set; } // float
		[Column("realDataType",             DbType="real",              DataType=DBLayer.DataType.Single),                                               Nullable            ] public float?          RealDataType             { get; set; } // real
		[Column("datetimeDataType",         DbType="datetime",          DataType=DBLayer.DataType.DateTime),                                             Nullable            ] public DateTime?       DatetimeDataType         { get; set; } // datetime
		[Column("smalldatetimeDataType",    DbType="smalldatetime",     DataType=DBLayer.DataType.SmallDateTime),                                        Nullable            ] public DateTime?       SmalldatetimeDataType    { get; set; } // smalldatetime
		[Column("charDataType",             DbType="char(1)",           DataType=DBLayer.DataType.Char,           Length=1),                             Nullable            ] public char?           CharDataType             { get; set; } // char(1)
		[Column("char20DataType",           DbType="char(20)",          DataType=DBLayer.DataType.Char,           Length=20),                            Nullable            ] public string?         Char20DataType           { get; set; } // char(20)
		[Column("varcharDataType",          DbType="varchar(20)",       DataType=DBLayer.DataType.VarChar,        Length=20),                            Nullable            ] public string?         VarcharDataType          { get; set; } // varchar(20)
		[Column("textDataType",             DbType="text",              DataType=DBLayer.DataType.Text),                                                 Nullable            ] public string?         TextDataType             { get; set; } // text
		[Column("ncharDataType",            DbType="nchar(20)",         DataType=DBLayer.DataType.NChar,          Length=20),                            Nullable            ] public string?         NcharDataType            { get; set; } // nchar(20)
		[Column("nvarcharDataType",         DbType="nvarchar(20)",      DataType=DBLayer.DataType.NVarChar,       Length=20),                            Nullable            ] public string?         NvarcharDataType         { get; set; } // nvarchar(20)
		[Column("ntextDataType",            DbType="ntext",             DataType=DBLayer.DataType.NText),                                                Nullable            ] public string?         NtextDataType            { get; set; } // ntext
		[Column("binaryDataType",           DbType="binary(1)",         DataType=DBLayer.DataType.Binary,         Length=1),                             Nullable            ] public byte[]?         BinaryDataType           { get; set; } // binary(1)
		[Column("varbinaryDataType",        DbType="varbinary(1)",      DataType=DBLayer.DataType.VarBinary,      Length=1),                             Nullable            ] public byte[]?         VarbinaryDataType        { get; set; } // varbinary(1)
		[Column("imageDataType",            DbType="image",             DataType=DBLayer.DataType.Image),                                                Nullable            ] public byte[]?         ImageDataType            { get; set; } // image
		[Column("timestampDataType",        DbType="timestamp",         DataType=DBLayer.DataType.Timestamp,      SkipOnInsert=true, SkipOnUpdate=true), Nullable            ] public byte[]?         TimestampDataType        { get; set; } // timestamp
		[Column("uniqueidentifierDataType", DbType="uniqueidentifier",  DataType=DBLayer.DataType.Guid),                                                 Nullable            ] public Guid?           UniqueidentifierDataType { get; set; } // uniqueidentifier
		[Column("sql_variantDataType",      DbType="sql_variant",       DataType=DBLayer.DataType.Variant),                                              Nullable            ] public object?         SqlVariantDataType       { get; set; } // sql_variant
		[Column("nvarchar_max_DataType",    DbType="nvarchar(max)",     DataType=DBLayer.DataType.NVarChar,       Length=int.MaxValue),                  Nullable            ] public string?         NvarcharMaxDataType      { get; set; } // nvarchar(max)
		[Column("varchar_max_DataType",     DbType="varchar(max)",      DataType=DBLayer.DataType.VarChar,        Length=int.MaxValue),                  Nullable            ] public string?         VarcharMaxDataType       { get; set; } // varchar(max)
		[Column("varbinary_max_DataType",   DbType="varbinary(max)",    DataType=DBLayer.DataType.VarBinary,      Length=int.MaxValue),                  Nullable            ] public byte[]?         VarbinaryMaxDataType     { get; set; } // varbinary(max)
		[Column("xmlDataType",              DbType="xml",               DataType=DBLayer.DataType.Xml),                                                  Nullable            ] public string?         XmlDataType              { get; set; } // xml
		[Column("datetime2DataType",        DbType="datetime2(7)",      DataType=DBLayer.DataType.DateTime2,      Precision=7),                          Nullable            ] public DateTime?       Datetime2DataType        { get; set; } // datetime2(7)
		[Column("datetimeoffsetDataType",   DbType="datetimeoffset(7)", DataType=DBLayer.DataType.DateTimeOffset, Precision=7),                          Nullable            ] public DateTimeOffset? DatetimeoffsetDataType   { get; set; } // datetimeoffset(7)
		[Column("datetimeoffset0DataType",  DbType="datetimeoffset(0)", DataType=DBLayer.DataType.DateTimeOffset, Precision=0),                          Nullable            ] public DateTimeOffset? Datetimeoffset0DataType  { get; set; } // datetimeoffset(0)
		[Column("datetimeoffset1DataType",  DbType="datetimeoffset(1)", DataType=DBLayer.DataType.DateTimeOffset, Precision=1),                          Nullable            ] public DateTimeOffset? Datetimeoffset1DataType  { get; set; } // datetimeoffset(1)
		[Column("datetimeoffset2DataType",  DbType="datetimeoffset(2)", DataType=DBLayer.DataType.DateTimeOffset, Precision=2),                          Nullable            ] public DateTimeOffset? Datetimeoffset2DataType  { get; set; } // datetimeoffset(2)
		[Column("datetimeoffset3DataType",  DbType="datetimeoffset(3)", DataType=DBLayer.DataType.DateTimeOffset, Precision=3),                          Nullable            ] public DateTimeOffset? Datetimeoffset3DataType  { get; set; } // datetimeoffset(3)
		[Column("datetimeoffset4DataType",  DbType="datetimeoffset(4)", DataType=DBLayer.DataType.DateTimeOffset, Precision=4),                          Nullable            ] public DateTimeOffset? Datetimeoffset4DataType  { get; set; } // datetimeoffset(4)
		[Column("datetimeoffset5DataType",  DbType="datetimeoffset(5)", DataType=DBLayer.DataType.DateTimeOffset, Precision=5),                          Nullable            ] public DateTimeOffset? Datetimeoffset5DataType  { get; set; } // datetimeoffset(5)
		[Column("datetimeoffset6DataType",  DbType="datetimeoffset(6)", DataType=DBLayer.DataType.DateTimeOffset, Precision=6),                          Nullable            ] public DateTimeOffset? Datetimeoffset6DataType  { get; set; } // datetimeoffset(6)
		[Column("datetimeoffset7DataType",  DbType="datetimeoffset(7)", DataType=DBLayer.DataType.DateTimeOffset, Precision=7),                          Nullable            ] public DateTimeOffset? Datetimeoffset7DataType  { get; set; } // datetimeoffset(7)
		[Column("dateDataType",             DbType="date",              DataType=DBLayer.DataType.Date),                                                 Nullable            ] public DateTime?       DateDataType             { get; set; } // date
		[Column("timeDataType",             DbType="time(7)",           DataType=DBLayer.DataType.Time,           Precision=7),                          Nullable            ] public TimeSpan?       TimeDataType             { get; set; } // time(7)
	}
	...
	public partial class AllTypes2
	{
		...
		[Column("datetime2DataType",      DbType="datetime2(7)",      DataType=DBLayer.DataType.DateTime2,      Precision=7), Nullable            ] public DateTime?       Datetime2DataType      { get; set; } // datetime2(7)
		[Column("timeDataType",           DbType="time(7)",           DataType=DBLayer.DataType.Time,           Precision=7), Nullable            ] public TimeSpan?       TimeDataType           { get; set; } // time(7)
		[Column("hierarchyidDataType",    DbType="hierarchyid",       DataType=DBLayer.DataType.Udt),                         Nullable            ] public SqlHierarchyId? HierarchyidDataType    { get; set; } // hierarchyid
		[Column("geographyDataType",      DbType="geography",         DataType=DBLayer.DataType.Udt),                         Nullable            ] public SqlGeography?   GeographyDataType      { get; set; } // geography
		[Column("geometryDataType",       DbType="geometry",          DataType=DBLayer.DataType.Udt),                         Nullable            ] public SqlGeometry?    GeometryDataType       { get; set; } // geometry
	}

	[Table("Child")]
	public partial class Child
	{
		[Column(       DbType="int", DataType=DBLayer.DataType.Int32), Nullable            ] public int? ParentID { get; set; } // int
		/// <summary>
		/// This ChildID column
		/// </summary>
		[Column(       DbType="int", DataType=DBLayer.DataType.Int32), Nullable            ] public int? ChildID  { get; set; } // int
		[Column("_ID", DbType="int", DataType=DBLayer.DataType.Int32), PrimaryKey, Identity] public int  Id       { get; set; } // int
	}

	[Table("CollatedTable")]
	public partial class CollatedTable
	{
		[Column(DbType="int",          DataType=DBLayer.DataType.Int32),               NotNull] public int    Id              { get; set; } // int
		[Column(DbType="nvarchar(20)", DataType=DBLayer.DataType.NVarChar, Length=20), NotNull] public string CaseSensitive   { get; set; } = null!; // nvarchar(20)
		[Column(DbType="nvarchar(20)", DataType=DBLayer.DataType.NVarChar, Length=20), NotNull] public string CaseInsensitive { get; set; } = null!; // nvarchar(20)
	}

	[Table("DataType")]
	public partial class DataType
	{
		[Column("id", DbType="int", DataType=DBLayer.DataType.Int32), NotNull] public int Id { get; set; } // int
	}

	[Table("DecimalOverflow")]
	public partial class DecimalOverflow
	{
		[Column(DbType="decimal(38, 20)", DataType=DBLayer.DataType.Decimal, Precision=38, Scale=20), PrimaryKey,  NotNull] public decimal  Decimal1 { get; set; } // decimal(38, 20)
		[Column(DbType="decimal(31, 2)",  DataType=DBLayer.DataType.Decimal, Precision=31, Scale=2),     Nullable         ] public decimal? Decimal2 { get; set; } // decimal(31, 2)
		[Column(DbType="decimal(38, 36)", DataType=DBLayer.DataType.Decimal, Precision=38, Scale=36),    Nullable         ] public decimal? Decimal3 { get; set; } // decimal(38, 36)
		[Column(DbType="decimal(29, 0)",  DataType=DBLayer.DataType.Decimal, Precision=29, Scale=0),     Nullable         ] public decimal? Decimal4 { get; set; } // decimal(29, 0)
		[Column(DbType="decimal(38, 38)", DataType=DBLayer.DataType.Decimal, Precision=38, Scale=38),    Nullable         ] public decimal? Decimal5 { get; set; } // decimal(38, 38)
	}

	[Table("Doctor")]
	public partial class Doctor
	{
		[Column(DbType="int",          DataType=DBLayer.DataType.Int32),               PrimaryKey, NotNull] public int    PersonID { get; set; } // int
		[Column(DbType="nvarchar(50)", DataType=DBLayer.DataType.NVarChar, Length=50),             NotNull] public string Taxonomy { get; set; } = null!; // nvarchar(50)
	}
	...
	public partial class GrandChild
	{
		[Column(       DbType="int", DataType=DBLayer.DataType.Int32), Nullable            ] public int? ParentID     { get; set; } // int
		[Column(       DbType="int", DataType=DBLayer.DataType.Int32), Nullable            ] public int? ChildID      { get; set; } // int
		[Column(       DbType="int", DataType=DBLayer.DataType.Int32), Nullable            ] public int? GrandChildID { get; set; } // int
		[Column("_ID", DbType="int", DataType=DBLayer.DataType.Int32), PrimaryKey, Identity] public int  Id           { get; set; } // int
	}
	...
	{
		[Column(DbType="uniqueidentifier", DataType=DBLayer.DataType.Guid),  PrimaryKey,  NotNull] public Guid ID     { get; set; } // uniqueidentifier
		[Column(DbType="int",              DataType=DBLayer.DataType.Int32),    Nullable         ] public int? Field1 { get; set; } // int
	}
	...
	{
		[Column(DbType="int", DataType=DBLayer.DataType.Int32), PrimaryKey(2), NotNull] public int PKField1    { get; set; } // int
		[Column(DbType="int", DataType=DBLayer.DataType.Int32), PrimaryKey(1), NotNull] public int PKField2    { get; set; } // int
		[Column(DbType="int", DataType=DBLayer.DataType.Int32),                NotNull] public int UniqueField { get; set; } // int
		[Column(DbType="int", DataType=DBLayer.DataType.Int32),                NotNull] public int IndexField  { get; set; } // int
	...
	{
		[Column(DbType="int",          DataType=DBLayer.DataType.Int32),               PrimaryKey,  NotNull] public int     InheritanceChildId  { get; set; } // int
		[Column(DbType="int",          DataType=DBLayer.DataType.Int32),                            NotNull] public int     InheritanceParentId { get; set; } // int
		[Column(DbType="int",          DataType=DBLayer.DataType.Int32),                  Nullable         ] public int?    TypeDiscriminator   { get; set; } // int
		[Column(DbType="nvarchar(50)", DataType=DBLayer.DataType.NVarChar, Length=50),    Nullable         ] public string? Name                { get; set; } // nvarchar(50)
	}

	[Table("InheritanceParent")]
	public partial class InheritanceParent
	{
		[Column(DbType="int",          DataType=DBLayer.DataType.Int32),               PrimaryKey,  NotNull] public int     InheritanceParentId { get; set; } // int
		[Column(DbType="int",          DataType=DBLayer.DataType.Int32),                  Nullable         ] public int?    TypeDiscriminator   { get; set; } // int
		[Column(DbType="nvarchar(50)", DataType=DBLayer.DataType.NVarChar, Length=50),    Nullable         ] public string? Name                { get; set; } // nvarchar(50)
	}
	...
	{
		[Column("id", DbType="hierarchyid", DataType=DBLayer.DataType.Udt), PrimaryKey, NotNull] public SqlHierarchyId Id { get; set; } // hierarchyid
	}
	...
	public partial class Issue1144
	{
		...
		/// Column description
		/// </summary>
		[Column("id", DbType="int", DataType=DBLayer.DataType.Int32), PrimaryKey, NotNull] public int Id { get; set; } // int
	}
	...
	{
		[Column("_ID", DbType="int",              DataType=DBLayer.DataType.Int32),                            PrimaryKey, Identity] public int       Id             { get; set; } // int
		[Column(       DbType="int",              DataType=DBLayer.DataType.Int32),                            Nullable            ] public int?      ID             { get; set; } // int
		[Column(       DbType="decimal(10, 4)",   DataType=DBLayer.DataType.Decimal,   Precision=10, Scale=4), Nullable            ] public decimal?  MoneyValue     { get; set; } // decimal(10, 4)
		[Column(       DbType="datetime",         DataType=DBLayer.DataType.DateTime),                         Nullable            ] public DateTime? DateTimeValue  { get; set; } // datetime
		[Column(       DbType="datetime2(7)",     DataType=DBLayer.DataType.DateTime2, Precision=7),           Nullable            ] public DateTime? DateTimeValue2 { get; set; } // datetime2(7)
		[Column(       DbType="bit",              DataType=DBLayer.DataType.Boolean),                          Nullable            ] public bool?     BoolValue      { get; set; } // bit
		[Column(       DbType="uniqueidentifier", DataType=DBLayer.DataType.Guid),                             Nullable            ] public Guid?     GuidValue      { get; set; } // uniqueidentifier
		[Column(       DbType="varbinary(5000)",  DataType=DBLayer.DataType.VarBinary, Length=5000),           Nullable            ] public byte[]?   BinaryValue    { get; set; } // varbinary(5000)
		[Column(       DbType="smallint",         DataType=DBLayer.DataType.Int16),                            Nullable            ] public short?    SmallIntValue  { get; set; } // smallint
		[Column(       DbType="int",              DataType=DBLayer.DataType.Int32),                            Nullable            ] public int?      IntValue       { get; set; } // int
		[Column(       DbType="bigint",           DataType=DBLayer.DataType.Int64),                            Nullable            ] public long?     BigIntValue    { get; set; } // bigint
		[Column(       DbType="nvarchar(50)",     DataType=DBLayer.DataType.NVarChar,  Length=50),             Nullable            ] public string?   StringValue    { get; set; } // nvarchar(50)
	}

	[Table("Name.Test")]
	public partial class NameTest
	{
		[Column("Name.Test", DbType="int", DataType=DBLayer.DataType.Int32), Nullable] public int? NameTestColumn { get; set; } // int
	}
	...
	{
		[Column(       DbType="int", DataType=DBLayer.DataType.Int32), Nullable            ] public int? ParentID { get; set; } // int
		[Column(       DbType="int", DataType=DBLayer.DataType.Int32), Nullable            ] public int? Value1   { get; set; } // int
		[Column("_ID", DbType="int", DataType=DBLayer.DataType.Int32), PrimaryKey, Identity] public int  Id       { get; set; } // int
	}
	...
	public partial class ParentView
	{
		[Column(       DbType="int", DataType=DBLayer.DataType.Int32), Nullable] public int? ParentID { get; set; } // int
		[Column(       DbType="int", DataType=DBLayer.DataType.Int32), Nullable] public int? Value1   { get; set; } // int
		[Column("_ID", DbType="int", DataType=DBLayer.DataType.Int32), Identity] public int  Id       { get; set; } // int
	}
	...
	{
		[Column(DbType="int",           DataType=DBLayer.DataType.Int32),                PrimaryKey, NotNull] public int    PersonID  { get; set; } // int
		[Column(DbType="nvarchar(256)", DataType=DBLayer.DataType.NVarChar, Length=256),             NotNull] public string Diagnosis { get; set; } = null!; // nvarchar(256)
	}

	[Table("SameTableName")]
	public partial class SameTableName
	{
		[Column("id", DbType="int", DataType=DBLayer.DataType.Int32), Nullable] public int? Id { get; set; } // int
	}

	[Table("SqlTypes")]
	public partial class SqlType
	{
		[Column(DbType="int",         DataType=DBLayer.DataType.Int32), PrimaryKey,  NotNull] public int             ID  { get; set; } // int
		[Column(DbType="hierarchyid", DataType=DBLayer.DataType.Udt),      Nullable         ] public SqlHierarchyId? HID { get; set; } // hierarchyid
	}
	...
	public partial class TestMerge1
	{
		[Column(DbType="int",               DataType=DBLayer.DataType.Int32),                                  PrimaryKey,  NotNull] public int             Id              { get; set; } // int
		[Column(DbType="int",               DataType=DBLayer.DataType.Int32),                                     Nullable         ] public int?            Field1          { get; set; } // int
		[Column(DbType="int",               DataType=DBLayer.DataType.Int32),                                     Nullable         ] public int?            Field2          { get; set; } // int
		[Column(DbType="int",               DataType=DBLayer.DataType.Int32),                                     Nullable         ] public int?            Field3          { get; set; } // int
		[Column(DbType="int",               DataType=DBLayer.DataType.Int32),                                     Nullable         ] public int?            Field4          { get; set; } // int
		[Column(DbType="int",               DataType=DBLayer.DataType.Int32),                                     Nullable         ] public int?            Field5          { get; set; } // int
		[Column(DbType="bigint",            DataType=DBLayer.DataType.Int64),                                     Nullable         ] public long?           FieldInt64      { get; set; } // bigint
		[Column(DbType="bit",               DataType=DBLayer.DataType.Boolean),                                   Nullable         ] public bool?           FieldBoolean    { get; set; } // bit
		[Column(DbType="varchar(20)",       DataType=DBLayer.DataType.VarChar,        Length=20),                 Nullable         ] public string?         FieldString     { get; set; } // varchar(20)
		[Column(DbType="nvarchar(20)",      DataType=DBLayer.DataType.NVarChar,       Length=20),                 Nullable         ] public string?         FieldNString    { get; set; } // nvarchar(20)
		[Column(DbType="char(1)",           DataType=DBLayer.DataType.Char,           Length=1),                  Nullable         ] public char?           FieldChar       { get; set; } // char(1)
		[Column(DbType="nchar(1)",          DataType=DBLayer.DataType.NChar,          Length=1),                  Nullable         ] public char?           FieldNChar      { get; set; } // nchar(1)
		[Column(DbType="real",              DataType=DBLayer.DataType.Single),                                    Nullable         ] public float?          FieldFloat      { get; set; } // real
		[Column(DbType="float",             DataType=DBLayer.DataType.Double),                                    Nullable         ] public double?         FieldDouble     { get; set; } // float
		[Column(DbType="datetime",          DataType=DBLayer.DataType.DateTime),                                  Nullable         ] public DateTime?       FieldDateTime   { get; set; } // datetime
		[Column(DbType="datetimeoffset(7)", DataType=DBLayer.DataType.DateTimeOffset, Precision=7),               Nullable         ] public DateTimeOffset? FieldDateTime2  { get; set; } // datetimeoffset(7)
		[Column(DbType="varbinary(20)",     DataType=DBLayer.DataType.VarBinary,      Length=20),                 Nullable         ] public byte[]?         FieldBinary     { get; set; } // varbinary(20)
		[Column(DbType="uniqueidentifier",  DataType=DBLayer.DataType.Guid),                                      Nullable         ] public Guid?           FieldGuid       { get; set; } // uniqueidentifier
		[Column(DbType="decimal(24, 10)",   DataType=DBLayer.DataType.Decimal,        Precision=24, Scale=10),    Nullable         ] public decimal?        FieldDecimal    { get; set; } // decimal(24, 10)
		[Column(DbType="date",              DataType=DBLayer.DataType.Date),                                      Nullable         ] public DateTime?       FieldDate       { get; set; } // date
		[Column(DbType="time(7)",           DataType=DBLayer.DataType.Time,           Precision=7),               Nullable         ] public TimeSpan?       FieldTime       { get; set; } // time(7)
		[Column(DbType="varchar(20)",       DataType=DBLayer.DataType.VarChar,        Length=20),                 Nullable         ] public string?         FieldEnumString { get; set; } // varchar(20)
		[Column(DbType="int",               DataType=DBLayer.DataType.Int32),                                     Nullable         ] public int?            FieldEnumNumber { get; set; } // int
	}
	...
	{
		[Column(DbType="int", DataType=DBLayer.DataType.Int32), PrimaryKey, Identity] public int  Id    { get; set; } // int
		[Column(DbType="int", DataType=DBLayer.DataType.Int32), Nullable            ] public int? Field { get; set; } // int
	}
	...
	{
		[Column(DbType="int", DataType=DBLayer.DataType.Int32), PrimaryKey, NotNull] public int TestSchemaXID { get; set; } // int
		[Column(DbType="int", DataType=DBLayer.DataType.Int32),             NotNull] public int Field1        { get; set; } // int
	...
	{
		[Column(DbType="int", DataType=DBLayer.DataType.Int32), NotNull] public int TestSchemaXID       { get; set; } // int
		[Column(DbType="int", DataType=DBLayer.DataType.Int32), NotNull] public int ParentTestSchemaXID { get; set; } // int
		[Column(DbType="int", DataType=DBLayer.DataType.Int32), NotNull] public int OtherID             { get; set; } // int
	...
	public static partial class TestData2017DBStoredProcedures
	{
		...
		public static int ExecuteProcIntParameters(this TestData2017DB dataConnection, int? @input, ref int? @output)
		{
			var parameters = new []
			{
				new DataParameter("@input",  @input,  DBLayer.DataType.Int32),
				new DataParameter("@output", @output, DBLayer.DataType.Int32)
				{
		...
		public static int Issue1897(this TestData2017DB dataConnection, out int @return)
		{
			var parameters = new []
			{
				new DataParameter("@return", null, DBLayer.DataType.Int32)
				{
		...
		public static int OutRefEnumTest(this TestData2017DB dataConnection, string? @str, ref string? @outputStr, ref string? @inputOutputStr)
		{
			var parameters = new []
			{
				new DataParameter("@str",            @str,            DBLayer.DataType.VarChar)
				{
					Size = 50
				},
				new DataParameter("@outputStr",      @outputStr,      DBLayer.DataType.VarChar)
				{
					Direction = ParameterDirection.InputOutput,
					Size      = 50
				},
				new DataParameter("@inputOutputStr", @inputOutputStr, DBLayer.DataType.VarChar)
				{
					Direction = ParameterDirection.InputOutput,
					Size      = 50
				}
		...
		public static int OutRefTest(this TestData2017DB dataConnection, int? @ID, ref int? @outputID, ref int? @inputOutputID, string? @str, ref string? @outputStr, ref string? @inputOutputStr)
		{
			var parameters = new []
			{
				new DataParameter("@ID",             @ID,             DBLayer.DataType.Int32),
				new DataParameter("@outputID",       @outputID,       DBLayer.DataType.Int32)
				{
					Direction = ParameterDirection.InputOutput
				},
				new DataParameter("@inputOutputID",  @inputOutputID,  DBLayer.DataType.Int32)
				{
					Direction = ParameterDirection.InputOutput
				},
				new DataParameter("@str",            @str,            DBLayer.DataType.VarChar)
		...
		public static List<PatientSelectByNameResult> PatientSelectByName(this TestData2017DB dataConnection, string? @firstName, string? @lastName)
		{
			var parameters = new []
			{
				new DataParameter("@firstName", @firstName, DBLayer.DataType.NVarChar)
				{
					Size = 50
				},
				new DataParameter("@lastName",  @lastName,  DBLayer.DataType.NVarChar)
				{
					Size = 50
				}
			};
		...
		public static int PersonDelete(this TestData2017DB dataConnection, int? @PersonID)
		{
			var parameters = new []
			{
				new DataParameter("@PersonID", @PersonID, DBLayer.DataType.Int32)
			};
		...
		public static List<PersonInsertResult> PersonInsert(this TestData2017DB dataConnection, string? @FirstName, string? @LastName, string? @MiddleName, char? @Gender)
		{
			var parameters = new []
			{
				...
				new DataParameter("@MiddleName", @MiddleName, DBLayer.DataType.NVarChar)
				{
					Size = 50
				},
				new DataParameter("@Gender",     @Gender,     DBLayer.DataType.Char)
				{
					Size = 1
				}
			};
		...
		public static List<QueryProcMultipleParametersResult> QueryProcMultipleParameters(this TestData2017DB dataConnection, int? @input, ref int? @output1, ref int? @output2, ref int? @output3)
		{
			...
			{
				new DataParameter("@input",   @input,   DBLayer.DataType.Int32),
				new DataParameter("@output1", @output1, DBLayer.DataType.Int32)
				{
					Direction = ParameterDirection.InputOutput
				},
				new DataParameter("@output2", @output2, DBLayer.DataType.Int32)
				{
					Direction = ParameterDirection.InputOutput
				},
				new DataParameter("@output3", @output3, DBLayer.DataType.Int32)
				{
					Direction = ParameterDirection.InputOutput
				}
			};
		...
		public static List<TableTypeTestProcResult> TableTypeTestProc(this TestData2017DB dataConnection, DataTable? @table)
		{
			var parameters = new []
			{
				new DataParameter("@table", @table, DBLayer.DataType.Structured)
				{
		...
		public static List<VariableResultsResult> VariableResults(this TestData2017DB dataConnection, bool? @ReturnFullRow)
		{
			var parameters = new []
			{
				new DataParameter("@ReturnFullRow", @ReturnFullRow, DBLayer.DataType.Boolean)
			};
	...
	public static partial class MySchemaSchema
	{
		...
		{
			[Column(DbType="int", DataType=DBLayer.DataType.Int32), PrimaryKey, NotNull] public int TestSchemaAID { get; set; } // int
			[Column(DbType="int", DataType=DBLayer.DataType.Int32),             NotNull] public int Field1        { get; set; } // int
		...
		{
			[Column(                           DbType="int", DataType=DBLayer.DataType.Int32), PrimaryKey, NotNull] public int TestSchemaBID       { get; set; } // int
			[Column(                           DbType="int", DataType=DBLayer.DataType.Int32),             NotNull] public int OriginTestSchemaAID { get; set; } // int
			[Column(                           DbType="int", DataType=DBLayer.DataType.Int32),             NotNull] public int TargetTestSchemaAID { get; set; } // int
			[Column("Target_Test_Schema_A_ID", DbType="int", DataType=DBLayer.DataType.Int32),             NotNull] public int TargetTestSchemaAId { get; set; } // int
