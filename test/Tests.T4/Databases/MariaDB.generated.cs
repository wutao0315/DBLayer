...
namespace MariaDBDataContext
{
	...
	public static partial class TestdbDBStoredProcedures
	{
		...
		public static int TestOutputParametersWithoutTableProcedure(this TestdbDB dataConnection, string? aInParam, out bool? aOutParam)
		{
			var parameters = new []
			{
				new DataParameter("aInParam",  aInParam,  DBLayer.DataType.VarChar)
				{
					Size = 256
				},
				new DataParameter("aOutParam", null, DBLayer.DataType.SByte)
				{
		...
		public static IEnumerable<Person> TestProcedure(this TestdbDB dataConnection, int? param3, ref int? param2, out int? param1)
		{
			var parameters = new []
			{
				new DataParameter("param3", param3, DBLayer.DataType.Int32),
				new DataParameter("param2", param2, DBLayer.DataType.Int32)
				{
					Direction = ParameterDirection.InputOutput
				},
				new DataParameter("param1", null, DBLayer.DataType.Int32)
				{
					Direction = ParameterDirection.Output
				}
			};
		...
		public static IEnumerable<Issue2313ParametersResult> Issue2313Parameters(this TestdbDB dataConnection, string? VarChar255, char? VarChar1, string? Char255, char? Char1, byte[]? VarBinary255, byte[]? Binary255, byte[]? TinyBlob, byte[]? Blob, byte[]? MediumBlob, byte[]? LongBlob, string? TinyText, string? Text, string? MediumText, string? LongText, DateTime? Date, DateTime? DateTime, DateTime? TimeStamp, TimeSpan? Time, string? Json, sbyte? TinyInt, byte? TinyIntUnsigned, short? SmallInt, ushort? SmallIntUnsigned, int? MediumInt, uint? MediumIntUnsigned, int? Int, uint? IntUnsigned, long? BigInt, ulong? BigIntUnsigned, decimal? Decimal, float? Float, double? Double, bool? Boolean, bool? Bit1, byte? Bit8, ushort? Bit10, ushort? Bit16, uint? Bit32, ulong? Bit64, string? Enum, string? Set, int? Year, byte[]? Geometry, byte[]? Point, byte[]? LineString, byte[]? Polygon, byte[]? MultiPoint, byte[]? MultiLineString, byte[]? MultiPolygon, byte[]? GeometryCollection)
		{
			var parameters = new []
			{
				new DataParameter("VarChar255",         VarChar255,         DBLayer.DataType.VarChar)
				{
					Size = 255
				},
				new DataParameter("VarChar1",           VarChar1,           DBLayer.DataType.VarChar)
				{
					Size = 1
				},
				new DataParameter("Char255",            Char255,            DBLayer.DataType.Char)
				{
					Size = 255
				},
				new DataParameter("Char1",              Char1,              DBLayer.DataType.Char)
				{
					Size = 1
				},
				new DataParameter("VarBinary255",       VarBinary255,       DBLayer.DataType.VarBinary)
				{
					Size = 255
				},
				new DataParameter("Binary255",          Binary255,          DBLayer.DataType.Binary)
				{
					Size = 255
				},
				new DataParameter("TinyBlob",           TinyBlob,           DBLayer.DataType.Blob)
				{
					Size = 255
				},
				new DataParameter("Blob",               Blob,               DBLayer.DataType.Blob)
				{
					Size = 65535
				},
				new DataParameter("MediumBlob",         MediumBlob,         DBLayer.DataType.Blob)
				{
					Size = 16777215
				},
				new DataParameter("LongBlob",           LongBlob,           DBLayer.DataType.Blob)
				{
					Size = 2147483647
				},
				new DataParameter("TinyText",           TinyText,           DBLayer.DataType.Text)
				{
					Size = 255
				},
				new DataParameter("Text",               Text,               DBLayer.DataType.Text)
				{
					Size = 65535
				},
				new DataParameter("MediumText",         MediumText,         DBLayer.DataType.Text)
				{
					Size = 16777215
				},
				new DataParameter("LongText",           LongText,           DBLayer.DataType.Text)
				{
					Size = 2147483647
				},
				new DataParameter("Date",               Date,               DBLayer.DataType.Date),
				new DataParameter("DateTime",           DateTime,           DBLayer.DataType.DateTime),
				new DataParameter("TimeStamp",          TimeStamp,          DBLayer.DataType.DateTime),
				new DataParameter("Time",               Time,               DBLayer.DataType.Time),
				new DataParameter("Json",               Json,               DBLayer.DataType.Text)
				{
					Size = 2147483647
				},
				new DataParameter("TinyInt",            TinyInt,            DBLayer.DataType.SByte),
				new DataParameter("TinyIntUnsigned",    TinyIntUnsigned,    DBLayer.DataType.Byte),
				new DataParameter("SmallInt",           SmallInt,           DBLayer.DataType.Int16),
				new DataParameter("SmallIntUnsigned",   SmallIntUnsigned,   DBLayer.DataType.UInt16),
				new DataParameter("MediumInt",          MediumInt,          DBLayer.DataType.Int32),
				new DataParameter("MediumIntUnsigned",  MediumIntUnsigned,  DBLayer.DataType.UInt32),
				new DataParameter("Int",                Int,                DBLayer.DataType.Int32),
				new DataParameter("IntUnsigned",        IntUnsigned,        DBLayer.DataType.UInt32),
				new DataParameter("BigInt",             BigInt,             DBLayer.DataType.Int64),
				new DataParameter("BigIntUnsigned",     BigIntUnsigned,     DBLayer.DataType.UInt64),
				new DataParameter("Decimal",            Decimal,            DBLayer.DataType.Decimal),
				new DataParameter("Float",              Float,              DBLayer.DataType.Single),
				new DataParameter("Double",             Double,             DBLayer.DataType.Double),
				new DataParameter("Boolean",            Boolean,            DBLayer.DataType.SByte),
				new DataParameter("Bit1",               Bit1,               DBLayer.DataType.BitArray),
				new DataParameter("Bit8",               Bit8,               DBLayer.DataType.BitArray),
				new DataParameter("Bit10",              Bit10,              DBLayer.DataType.BitArray),
				new DataParameter("Bit16",              Bit16,              DBLayer.DataType.BitArray),
				new DataParameter("Bit32",              Bit32,              DBLayer.DataType.BitArray),
				new DataParameter("Bit64",              Bit64,              DBLayer.DataType.BitArray),
				new DataParameter("Enum",               Enum,               DBLayer.DataType.VarChar)
				{
					Size = 3
				},
				new DataParameter("Set",                Set,                DBLayer.DataType.VarChar)
				{
					Size = 3
				},
				new DataParameter("Year",               Year,               DBLayer.DataType.Int32),
				new DataParameter("Geometry",           Geometry,           DBLayer.DataType.Undefined),
				new DataParameter("Point",              Point,              DBLayer.DataType.Undefined),
				new DataParameter("LineString",         LineString,         DBLayer.DataType.Undefined),
				new DataParameter("Polygon",            Polygon,            DBLayer.DataType.Undefined),
				new DataParameter("MultiPoint",         MultiPoint,         DBLayer.DataType.Undefined),
				new DataParameter("MultiLineString",    MultiLineString,    DBLayer.DataType.Undefined),
				new DataParameter("MultiPolygon",       MultiPolygon,       DBLayer.DataType.Undefined),
				new DataParameter("GeometryCollection", GeometryCollection, DBLayer.DataType.Undefined)
			};
