...
{
	public partial class EquatableDB : DBLayer.Data.DataConnection
	{
		...
		public EquatableDB(DBLayerConnectionOptions options)
			: base(options)
		{
			InitDataContext();
			InitMappingSchema();
		...
		public EquatableDB(DBLayerConnectionOptions<EquatableDB> options)
			: base(options)
		{
			InitDataContext();
			InitMappingSchema();
